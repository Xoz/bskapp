...
describe("matchutvärderingens öppningstid", () => {
  it("öppnar 75 minuter efter avspark på matchdagen", () => {
    expect(matchEvaluationIsOpen("2026-08-21", "18:45", "2026-08-21", 19 * 60 + 59)).toBe(false);
    expect(matchEvaluationIsOpen("2026-08-21", "18:45", "2026-08-21", 20 * 60)).toBe(true);
  });
