...
| **Filfri Svenska Lag-synk** | `docs/SVENSKALAG_SYNC.md`, `lib/svenskalag/{model,import,actions}.ts`, `scripts/svenskalag/{collect,run,login}.ts`, `components/SvenskaLagSyncStatus.tsx`, `deploy/svenskalag/`. Befintlig settings-tabell används för status/kö/historik; inga migrationer. |
