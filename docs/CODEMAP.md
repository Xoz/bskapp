...
> Uppdatering 2026-07-13: övningsritaren är nu statisk; sekvensspelaren och bollinterpoleringen är borttagna. Den har planmallar, spelare/lagfärger, boll, koner, pinnar, stora mål/minimål, zoner, text och skilda linjer för passning/löpning/dribbling. `saveDiagram` använder `sql.json` för `objects` och `actions`.
